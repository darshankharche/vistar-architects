        ...
        <div className='about'>
            <h1 className='about-head'>About</h1>
                <p className='about-para'>Vistar Architects is a multi-dimensional firm based out of Jalgaon. 
                    ...
                    inventive approach to construction and renovation to achieve an elegant product. </p>
                <p className='about-para'>Established in 2022, the practice portfolio comprising of residential projects, 
            ...
            <div className='about-section'>
                ...
                <div className='about-sub-section'>
                    <h1><span className="sub-header">Ar. Mohit Metkar</span></h1>
                    <h2>Professional Architectural and Interior Photographer</h2>
